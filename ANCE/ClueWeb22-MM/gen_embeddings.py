...
import clip
from data import load_caps, load_docs, load_file, ClueWebDataset
...
class ImgDataset(Dataset):
    def __init__(self, args, preprocess, tokenizer, max_text_len,img_doc, captions=None):
...
if __name__ == '__main__':
    ...
    if args.encode_img:
        ...
        img_data = ImgDataset(args, image_processor, t5_tokenizer, args.max_text_len,img_doc,
                              captions=captions)
