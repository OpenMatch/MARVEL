...
--train_path ../../DPR/WebQA/checkpoint_multi_inb_webqa/train_all.json \
--valid_path ../../DPR/WebQA/checkpoint_multi_inb_webqa/dev_all.json \
...
--valid_batch_size 64 \
--text_len 128 \
--pretrained_model_path ../../DPR/WebQA/checkpoint_multi_inb_webqa/model.best.pt \
