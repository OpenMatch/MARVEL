...
if __name__ == '__main__':
    ...
    train_data = WebQADataset(args, image_processor, tokenizer, train_data, docs, captions=captions, shuffle=True,img_special_len=img_patch_token_size)
    ...
    args_dev.neg_num = 1
    valid_data = WebQADataset(args_dev,image_processor, tokenizer, valid_data, docs, captions=captions, shuffle=False,img_special_len=img_patch_token_size)
